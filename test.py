...
hx_ene_array,hx_time_array,hxtime=HX.get_HX_data_with_SiO2(shot,module_num,trigger,gain,lowene) #石英窓の影響考慮
...
width=15e-3
hx_time_ave,hx_int_ave=average_convolve.average_convolve_boxcar(width,hxtime_sel,hxint_sel)
